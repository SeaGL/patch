...
//  console.info("joinedRooms: %j", joinedRoomIds);
//  for (const jr of joinedRoomIds) {
//    try {
//      const jroomState = await limiter.schedule(() =>
//        client.getRoomState(jr)
//      );

//      try {
//        console.info("joinedRoomId: %j", jroomState.find(e => e.type === 'm.room.create').room_id,);
//      } catch (error: any) {
//        if (error instanceof TypeError) {
//          console.info("joinedRoomCreate not found")
//        } else {
//          throw error;
//        }
//      }
...
//      try {
//        console.info("joinedRoomName: %j", jroomState.find(e => e.type === 'm.room.name').content.name);
//      } catch (error: any) {
//        if (error instanceof TypeError) {
//          console.info("joinedRoomName not found")
//        } else {
//          throw error;
//        }
//      }
...
//      try {
//        console.info("joinedRoomJoinRules: %j", jroomState.find(e => e.type === 'm.room.join_rules').content.join_rule);
//      } catch (error: any) {
//        if (error instanceof TypeError) {
//          console.info("joinedRoomJoinRules not found")
//        } else {
//          throw error;
//        }
//      }
...
//      try {
//        console.info("joinedRoomAliases: %j", jroomState.find(e => e.type === 'm.room.canonical_alias').content);
//      } catch (error: any) {
//        if (error instanceof TypeError) {
//          console.info("joinedRoomAliases not found")
//        } else {
//          throw error;
//        }
//      }
